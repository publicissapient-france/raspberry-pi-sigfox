...
#ifndef cookingSigfox_h
#define cookingSigfox_h

// NO IMPLEMENTED in Raspberry Pi Connection Board
// Pin definition for Sigfox module Powe up : 
const int SIGFOX_PW =  12;
...
/*! @class cookingSigFox
 * cookingSigFox Class defines all the variables and functions used to manage 
 * TD1207 modules
 */
class cookingSigfox : public cookingUART
{
