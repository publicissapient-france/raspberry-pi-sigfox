 ...
 * @return	void
 */
void cookingSigfox::generator(uint8_t type, int n, const char *cmdCode, ...)
{	
	// define pointer 
	char* pointer;
    ...
    {		
		...
		{	
			...
			else
			{
				//error
				#if DEBUG_SIGFOX > 0
					printf("[debug] not enough buffer size\n");
				#endif
				memset( _command, 0x00, sizeof(_command) );
				return (void)0;				
			}
 ...
 * @return	parsed value
 */
uint32_t cookingSigfox::parseHexValue()
{
	char * pch;	
 ...
 * @return	parsed value
 */
uint8_t cookingSigfox::parseUint8Value()
{
	char * pch;	
	pch = strtok((char*) _buffer,"\r\nOKERROR");
	if (pch != NULL)
 ...
 * @return	parsed value
 */
uint32_t cookingSigfox::parseUint32Value()
{
	char * pch;	
	pch = strtok((char*) _buffer,"\r\nOKERROR");
	if (pch != NULL)
 ...
 */
uint8_t cookingSigfox::ON(uint8_t socket)
{
	_baudrate = UART_RATE;
	_uart = socket;
 ...
 * 	@arg	'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t cookingSigfox::OFF(uint8_t socket)
{
	if (socket == SOCKET0)
	{  
		_uart = SOCKET0;
 ...
 * 	@arg	'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t cookingSigfox::setPower(uint8_t power)
{
	uint8_t answer;
 ...
 * 	@arg	'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t cookingSigfox::getPower()
{
	uint8_t answer;
 ...
 * 	@arg	'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t cookingSigfox::saveSettings()
{	
	// enter command mode
 ...
 * 
 */
uint8_t cookingSigfox::factorySettings()
{
	uint8_t status;	
 ...
 * 
 */
uint8_t cookingSigfox::defaultConfiguration()
{
	uint8_t answer;	
 ...
 * 	@arg	'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t cookingSigfox::send(char* data)
{
	...
	if (length>24)
	{
        ...
        printf("ERROR: Sigfox packet too large\n");
 ...
 * 	@arg	'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t cookingSigfox::send(uint8_t* data, uint16_t length)
{
	//define buffer
 ...
 * 	@arg	'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t cookingSigfox::sendACK(uint8_t* data, uint16_t length)
{
	//define buffer
	char ascii_command[30];
 ...
 * 	@arg	'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t cookingSigfox::testTransmit(uint16_t count, uint16_t period, int channel)
{
	char param1[20];
	char param2[20];
	char param3[20];
	...
	// convert to string
    sprintf(param1,"%d",(uint16_t)count);
    sprintf(param2,"%d",(uint16_t)period);
    sprintf(param3,"%d",channel);
 ...
 * 	@arg	'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t cookingSigfox::showFirmware()
{
	uint8_t status;
 ...
 * 	@arg	'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t cookingSigfox::sendKeepAlive()
{
 ...
 * 	@arg	'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t cookingSigfox::sendKeepAlive(uint8_t period)
{
	char param1[20];
	uint8_t answer;
 ...
 * 	@arg	'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t cookingSigfox::continuosWave(uint32_t freq, bool enable)
{
	char param1[20];
	...
	// convert to string	
    sprintf(param1,"%d",(uint16_t)enable);
 ...
 * 
 */
uint8_t cookingSigfox::setAddressLAN(uint32_t naddress)
{
	uint8_t status;	
 ...
 * 
 */
uint8_t cookingSigfox::getAddressLAN()
{
	uint8_t status;	
 ...
 * 
 */
uint8_t cookingSigfox::setMask(uint32_t nmask)
{
	uint8_t status;	
 ...
 * 
 */
uint8_t cookingSigfox::setFrequency(uint32_t freq)
{
	uint8_t status;	
 ...
 * 
 */
uint8_t cookingSigfox::getFrequency()
{
	uint8_t status;	
 ...
 * 
 */
uint8_t cookingSigfox::setPowerLAN(int power)
{
	uint8_t status;	
 ...
 * 
 */
uint8_t cookingSigfox::getPowerLAN()
{
	uint8_t status;	
 ...
 * 
 */
uint8_t cookingSigfox::sendLAN(uint8_t* data, uint16_t length)
{	
 ...
 * 
 */
uint8_t cookingSigfox::sendLAN(char* data)
{	
	uint8_t status;	
	uint16_t length = strlen(data);
 ...
 * 	@arg	'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t cookingSigfox::parsePacketLAN()
{
	char* pch;	
 ...
 * 
 */
uint8_t cookingSigfox::receive(uint32_t wait)
{	
	uint8_t status;	
 ...
 * 
 */
uint8_t cookingSigfox::setMultiPacket()
{
	uint8_t status;	
 ...
 * 
 */
uint8_t cookingSigfox::disableRX()
{
	uint8_t status;	
 ...
 * 	@arg	'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t cookingSigfox::getMultiPacket(uint32_t time)
{
	uint8_t status;
...
cookingSigfox Sigfox = cookingSigfox();
